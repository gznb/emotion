...
class d2UserModel(mongoengine.DynamicDocument):
    ...
    GuserUsername = mongoengine.StringField(max_length=16)                      # 姓名
    ...
    '''
    GuserRegistrationDate = mongoengine.DateTimeField(auto_now_add=True)        # 注册日期  年/月/日/时/分/秒
    ...
    GuserLastLogin = mongoengine.DateTimeField(auto_now=True)                   # 上次登陆时间  年/月/日/时/分/秒
